        ...
        7: [function (_dereq_, module, exports) {
            (function (global) {
                ...
                Card = (function () {
                    ...
                    Card.prototype.cardTemplate = '' + '<div class="jp-card-container">' + '<div class="jp-card">' + '<div class="jp-card-front">' + '<div class="jp-card-logo jp-card-visa">visa</div>' + '<div class="jp-card-logo jp-card-mastercard">MasterCard</div>' + '<div class="jp-card-logo jp-card-maestro">Maestro</div>' + '<div class="jp-card-logo jp-card-amex"></div>' + '<div class="jp-card-logo jp-card-discover">discover</div>' + '<div class="jp-card-logo jp-card-dankort"><div class="dk"><div class="d"></div><div class="k"></div></div></div>' + '<div class="jp-card-lower">' + '</div>' + '</div>' + '</div>';
...
function validateForm(event) {
    var cardInput = document.querySelector('input[name = "number"]');
    if (cardInput.classList.contains('unknown')) {
        alert("Not card type accept");
        event.preventDefault();
    } else {
        alert("Your card type accept");
    }
}
